...
export default {
  ...
  methods: {
    ...
    switchState(index, text) {
      ...
      mutations.getAreaLevel(this.level, this.index);
    ...
    changeProvince(value) {
      ...
      if (
        ...
        mutations.getAreaReply(province.label, 0, this.index);
      }
    },
    changeCity(value) {
      ...
      if (
        ...
        mutations.getAreaReply(city.label, 1, this.index);
      }
    },
    changeCounty(value) {
      let county;
      ...
      if (this.value.level === "county" || this.value.level === "address") {
        ...
        mutations.getAreaReply(county.label, 2, this.index);
      }
    },
    addressBlur() {
      if (this.value.level === "address") {
        mutations.getAreaReply(this.address, 3, this.index);
    ...
    upload(src) {
      ...
      mutations.getAreaTitleUrl(src, this.index);
    },
    uploadFail(msg) {
      console.log(msg);
      this.errorTip = msg;
